package com.orsoot.spoton.controller;
...
public class CameraController {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            backgroundHandler.post(new ImageSaver(context, reader.acquireNextImage(), file));
        }
    ...
    public void takePicture() {
        ...
        Random r = new Random();
        int num = r.nextInt(45 - 28) + 28;
//        file = getOutputMediaFile("image_"+ num+ ".jpg");
        file = getOutputMediaFile("image.jpg");
        try {
            if (null == mCameraDevice) {
                return;
            }
...
//        Toast.makeText(context, file.getAbsolutePath(), Toast.LENGTH_SHORT).show();
        ...
        Log.d(TAG, "takePicture: picture clicked!");
    }
        ...
        public void refreshGallery(File f) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                ...
                mContext.sendBroadcast(new Intent(
                        ...
                        Uri.parse("file://" + mContext.getExternalFilesDir("temp"))));
            }
        }
    }
...
//        File mediaStorageDir = new File(Environment.getExternalStorageDirectory().getPath()+ "/Intruders");
//        File mediaStorageDir = new File(String.valueOf(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM)));
//        File mediaStorageDir = new File(context.getExternalFilesDir(null) + "/Intruders");
        File mediaStorageDir =  context.getExternalFilesDir("temp");
        ...
        String fileName = mediaStorageDir.getPath() + File.separator + "image.jpg";
//        mediaFile = new File(mediaStorageDir.getPath() + File.separator + name);
         File mainPicture = new File(fileName);
         final File file = new File(mediaStorageDir.getPath()
                 + File.separator+ name);

         if (mainPicture.exists()) {
             mainPicture.renameTo(file);
         }
